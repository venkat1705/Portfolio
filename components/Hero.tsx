...
export default function Hero({}: Props) {
  ...
  return (
    <div className='h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden'>
        <BackgroundCircles/>
        <Image src={Profile} alt="profile" width={150} height={150} className='rounded-full object-cover'/>
    <div className='z-20'>
        ...
        <div className='pt-5'>
            ...
            <br/>
            <Link href="https://drive.google.com/file/d/1mdg1MHtgDKWOi9jJaqwY-sH8ddHESFqu/view?usp=share_link" download>
